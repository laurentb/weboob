...
class RadioFranceModule(Module, CapRadio, CapCollection, CapAudio):
    ...
    _RADIOS = {
        'franceinter': {u'title': u'France Inter',
                        ...
                        u'selection': u'lecteur_commun_json/reecoute-%s' % int(time.mktime(datetime.now().replace(hour=13, minute=0, second=0).timetuple()))},
        'franceculture': {u'title': u'France Culture',
                          u'player': u'player',
                          u'live': u'lecteur_commun_json/timeline',
                          u'podcast': u'podcasts',
                          u'selection': u'lecteur_commun_json/selection'},
        ...
        'francemusique': {u'title': u'France Musique',
                          u'player': u'player',
                          u'live': u'lecteur_commun_json/reecoute-%s' % int(time.mktime(datetime.now().replace(hour=13, minute=0, second=0).timetuple())),
        ...
        'fbbassenormandie': {u'title': u'France Bleu Basse Normandie (Caen)',
                             u'player': u'basse-normandie',
                             u'live': u'grid/basse-normandie'},
        ...
        'fbhautenormandie': {u'title': u'France Bleu Haute Normandie (Rouen)',
                             u'player': u'haute-normandie',
                             u'live': u'grid/haute-normandie'},
