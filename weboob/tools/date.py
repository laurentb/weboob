...
DATE_TRANSLATE_FR = [(re.compile(u'janvier', re.I),   u'january'),
                     (re.compile(u'f[eé]vrier', re.I),   u'february'),
                     ...
                     (re.compile(u'd[eé]c\\.', re.I), u'december'),
                     (re.compile(u'\\bd[eé]c\\b', re.I), u'december'),
