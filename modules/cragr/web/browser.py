...
class Cragr(Browser):
    ...
    PAGES = {'https?://[^/]+/':                                          HomePage,
             ...
             'https?://[^/]+/stb/collecteNI\?.*sessionAPP=Synthcomptes.*': AccountsPage,
             'https?://[^/]+/stb/entreeBam\?.*act=Synthcredits':         LoansPage,
             'https?://[^/]+/stb/collecteNI\?.*sessionAPP=Synthcredits.*': LoansPage,
             'https?://[^/]+/stb/entreeBam\?.*act=Synthepargnes':        SavingsPage,
             'https?://[^/]+/stb/collecteNI\?.*sessionAPP=Synthepargnes.*': SavingsPage,
