...
class INGVirtKeyboard(SimpleVirtualKeyboard):
    ...
    def __init__(self, file, cols, rows, browser, matching_symbols_coords=None, symbols=None):
        self.symbols = symbols or {}
        self.matching_symbols_coords = matching_symbols_coords or {}
...
class LoginPage(JsonPage):
    ...
    def init_vk(self, img, password):
        ...
        vk = INGVirtKeyboard(image, cols=5, rows=2, browser=self.browser, matching_symbols_coords=self.matching_symbols_coords, symbols=self.vk_symbols)
